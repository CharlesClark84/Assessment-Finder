<nav class="navbar navbar-inverse navbar-collapse">
    <div class="container">
        <ul class="nav navbar-nav navbar-collapse">
            ...
            <li><a href="rehab.jsp"><span class="glyphicon glyphicon-globe"></span> Treatment Facilities</a></li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="reportIssue.jsp"><span class="glyphicon glyphicon-user"></span> Report Issue</a></li>
                </ul>
            </li>

            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-question-sign"></span> Info to Help
                    <span class="caret"></span></a>
                <ul class="dropdown-menu">

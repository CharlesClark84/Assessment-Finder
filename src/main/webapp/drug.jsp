...
<div class="first">
    <form action="results.php" method="GET"><br>
        <fieldset>
            ...
            <input class="col-sm" id="date" name="date" type="date" value="<?php echo $date; ?>" size="30" /><br /><br />
            ...
            <input type="radio" name="question1" id="question1"  value="no"> No<br /><br />
            ...
            <input type="radio" name="question2" id="question2"  value="no"> No<br /><br />
            ...
            <input type="radio" name="question3" id="question3"  value="no"> No<br /><br />
            ...
            <input type="radio" name="sucide" id="sucide" yes checked> Yes<br>

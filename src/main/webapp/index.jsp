...
<div class="well index container">
        ...
        <br/>
        <div class="groupPic"><img src="pics/addictionTree.jpg" alt="addiction tree" height="75%" width="80%"></div>
        <br/>

        <h2 class="center"><span class="green">Effects of Drug Use</span></h2>
        ...
        <h2 id="factorsRiskyBehavior" class="center"><span class="green">Factors That Predispose You to Risky Behavior</span></h2>
        <p>&nbsp;&nbsp;&nbsp;&nbsp;You put yourself at risk for relapse if you fail to follow the strategies that support your recovery and, instead put yourself in circumstances that
            ...
            lead to straying from the recovery path:

        <ul>
        <li><span class="blue">Difficulty dealing with emotions</span>: Substance use is a common way that people attempt to deal with emotions, positive or negative, that feel too intense
        ...
        mood-altering substance, then you would likely benefit from learning and practicing some emotional coping skills, such as mindfulness or other
            cognitive-behavioral strategies. These can be gained through counseling or in a self-help education program.</li>

        <li><span class="blue">Testing of personal control</span>: At some point in your recovery, you may feel that you&apos;ve achieved your goal.  You feel that you have arrested your addictive
        tendencies and feel you no longer need to be so restrictive with yourself, you feel in control of yourself. Unfortunately, letting go just a bit often
            escalates until one has returned to old habits. The real test of control is when you can resist the urge to test your self-control.</li>

        <li><span class="blue">Feeling deprived</span>: Sometimes during recovery, it may feel that all the fun has been let out of your life. Your friends and coworkers can celebrate with a
        ...
        does require exceptional self-discipline. You may need to remind yourself that, while your reward for this does not involve temporary relief, it does offer
            you a lifetime of positive experiences and increasing self-fulfillment.</li>
        </ul>

        <h2 id="triggers" class="center"><span class="green">Triggers for Risk and How to Manage Them</span></h2>

        <p>&nbsp;&nbsp;&nbsp;&nbsp;Certain specific kinds of situations are more likely to lead to risky behavior. You can remove yourself from high risk situations if you recognize them
        early and have a plan to move away immediately.
        <ul>
        <li><span class="blue">Being in a using environment</span>:  If for some reason, you inadvertently find yourself in a place or among people who are using, leave immediately. You may
        have to abruptly leave a party without saying goodbye if someone suddenly pulls out drugs or paraphernalia. Do not worry about being rude. Your sobriety,
            and perhaps your life, are on the line, so social graces are the least of your concerns.</li>

        <li><span class="blue">Substituting one addictive substance for another</span>:  If you are recovering from drug use and have the need for pain medication, perhaps following an accident
        ...
        pain medications is one of the easiest ways that slips occur. Ask your doctor to suggest non-pharmacological forms of pain control (hypnosis, relaxation
            techniques, massage, acupuncture) when possible.</li>

        <li><span class="blue">Giving in to cravings</span>:  Physical cravings and the psychological desire for alcohol or drugs may take a long time to recede, and they can reoccur unexpectedly.
        ...
        (chew gum, drink an energy drink, exercise, etc.) and have mental and emotional resources available.
            You might create and use a personal mantra or affirmation. such as It&apos;s just a craving, or I am stronger than this fleeting feeling.</li>

           <li><span class="blue">Not having a support system</span>: Everyone needs a support system, especially when dealing with difficult tasks such as maintaining ongoing sobriety. Having
        ...
        Developing and using your support system is perhaps the most important thing you can do to manage your relapse risk.</li>
    </ul></p>
    </div>

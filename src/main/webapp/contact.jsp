...
<div class=" first center container">
    <div class="well index">
        <form action="contact" method="get" >
            ...
            <input id="cnt" name="cnt" type="text" placeholder="Enter Email"  size="30" required/><br /><br />

            <label for="reason">Reason:</label><br />
            <input id="reason" name="reason" type="text" placeholder="Enter Contact Reason"  size="30" required/><br /><br />
